...
public class DistributedLogAppender extends AppenderBase<ILoggingEvent> {
    ...
    public DistributedLogAppender() {
        ...
        this.executor = new ThreadPoolExecutor(1, 1, 10, TimeUnit.SECONDS, new ArrayBlockingQueue<>(1),
    ...
    private void batchHandle(List<ILoggingEvent> loggingEvents) throws IOException {
        ...
        System.out.println("日志：" + loggingEvents);
        // TODO json序列化
